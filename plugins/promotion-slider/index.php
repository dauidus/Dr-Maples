	...
	class promo_slider{
		...
		function __construct(){
			...
			new wordpress_custom_post_type($this->post_type, 
										   array('singular' => __('Slide', 'promotion-slider'), 
												 'plural' => __('Slides', 'promotion-slider'),
											     'slug' => 'promotion', 
		...
		function wp_admin_bar() {
			...
			$wp_admin_bar->add_menu( array( 'parent' => 'appearance', 
											...
											'title' => __('Slide Options', 'promotion-slider'), 
		...
		function admin_init(){ 
			...
			add_meta_box( 'promo_slider_meta_box', __('Slide Options', 'promotion-slider'), array($this, 'meta_box_content'), $this->post_type );
		...
		function admin_menu(){
			...
			$this->options_page = add_submenu_page( 'edit.php?post_type='.$this->post_type, 
												    __('Slide Options', 'promotion-slider'), 
												    __('Slide Options', 'promotion-slider'), 
												    'manage_options', 
												    'options', 
