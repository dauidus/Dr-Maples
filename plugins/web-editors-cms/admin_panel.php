...
<form id="wecms" method="post" enctype="multipart/form-data">
    ...
    <br />
    <h3>Admin Bar</h3>
    <p><label for="wecms_admin_support"><input style="width:500px;" type="text" name="wecms_admin_support" id="wecms_admin_support" value="<?php echo get_option('wecms_admin_support', 'http://www.yoursite.com/customer-support') ?>" /> Link to your support page</label></p>
    <p><label for="wecms_admin_docs"><input style="width:500px;" type="text" name="wecms_admin_docs" id="wecms_admin_docs" value="<?php echo get_option('wecms_admin_docs', 'http://www.yoursite.com/cms-docs.pdf') ?>" /> Link to your help documentation</label></p>
    </div>
    <div style="clear:both;">
...
function WE_process_cms_adjustments() {
    if($_POST['cms_settings_save'])
    {
        ...
        // admin bar
        update_option('wecms_admin_support', $_POST['wecms_admin_support'] );
        update_option('wecms_admin_docs', $_POST['wecms_admin_docs'] );
